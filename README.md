...
<figure>
<img src="man/figures/README-example.gif"
alt="Three circles animating into view with a staggered elastic entrance, followed by the middle circle expanding." />
<figcaption aria-hidden="true">Three circles animating into view with a
staggered elastic entrance, followed by the middle circle
expanding.</figcaption>
</figure>
...
inside the `props` list of `anime_add()`.
...
**Playback.** `anime_playback()` controls looping, direction, and an
optional play/pause/scrub control bar injected into the widget.
